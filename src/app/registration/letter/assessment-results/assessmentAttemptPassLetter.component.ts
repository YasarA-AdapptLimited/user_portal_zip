...
import { AssessmentAttemptsLetterData, PartOutcome } from '../../model/AssessmentAttemptsLetterData';
@Component({
  selector: 'app-assessment-attempt-pass-letter',
  moduleId: module.id,
  templateUrl: './assessmentAttemptPassLetter.component.html',
  styleUrls: ['../letter.scss']
})
export class AssessmentAttemptPassLetterComponent implements OnInit {

  registrantStartDate: any;
  registrant: Registrant;
  assessmentApproveData: AssessmentAttemptsLetterData;
