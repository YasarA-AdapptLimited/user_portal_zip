...
@Component({
  selector: 'app-assessment-first-second-attempt-fail-letter',
  moduleId: module.id,
  templateUrl: './assessmentFirstAndSecondAttemptFailLetter.component.html',
  styleUrls: ['../letter.scss']
})
export class AssessmentFirstAndSecondAttemptFailLetterComponent implements OnInit {
