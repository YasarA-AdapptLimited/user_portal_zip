...
import { CcpsApplicationReviewComponent } from './ccpsApplicationReview.component';

describe('RtrApplicationReviewComponent', () => {
  let component: CcpsApplicationReviewComponent;
  let fixture: ComponentFixture<CcpsApplicationReviewComponent>;
  let MockformStepperService,MockCCPSService;
  let application = {
    activeForm: {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ CcpsApplicationReviewComponent ],
      providers : [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CcpsApplicationReviewComponent);
