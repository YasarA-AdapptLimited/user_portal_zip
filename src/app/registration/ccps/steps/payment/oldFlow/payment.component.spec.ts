...
describe('PaymentOldComponent', () => {
  ...
  let component: PaymentOldComponent;
  let fixture: ComponentFixture<PaymentOldComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PaymentOldComponent);
