...
import { CCPSPersonalDetailsComponent } from './ccps-personal-details.component';

describe('PersonalDetailsComponent', () => {
  let component: CCPSPersonalDetailsComponent;
  let fixture: ComponentFixture<CCPSPersonalDetailsComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ CCPSPersonalDetailsComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CCPSPersonalDetailsComponent);
