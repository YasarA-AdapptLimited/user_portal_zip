...
import { OverseasRegularDetailsComponent } from './overseas-regular-details.component';
import { FormStepperService } from '../../../../shared/formStepper/formStepper.service';
import { RegistrationService } from '../../../../core/service/registration.service';

describe('OverseasRegularDetailsComponent', () => {
  let component: OverseasRegularDetailsComponent;
  let fixture: ComponentFixture<OverseasRegularDetailsComponent>;
  ...
  let MockFormStepperService, MockRegistrationService, MockChangeDetectorRef;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ OverseasRegularDetailsComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OverseasRegularDetailsComponent);
  ...
  it('if no country is selected, country is set as null', () => {
    component.onCountryChange({target: {value: null}});
    expect(component.professionalStandingDetail.country).toBe(null);
  });
});
