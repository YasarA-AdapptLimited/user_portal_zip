...
import { RtrReviewStepComponent } from './rtrReviewStep.component';

describe('RtrReviewStepComponent', () => {
  let component: RtrReviewStepComponent;
  let fixture: ComponentFixture<RtrReviewStepComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ RtrReviewStepComponent ],
      providers : [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RtrReviewStepComponent);
  ...
  it('title check -1 ', () => {
    ...
    expect(component.title).toBe('Review');
  });
