...
import { AssessmentReportConfirmTrainingStepComponent } from './assessmentReportConfirmTrainingStep.component';


describe('( Assessment Report ) => Confirm training ', () => {
    let component: AssessmentReportConfirmTrainingStepComponent;
    let fixture: ComponentFixture<AssessmentReportConfirmTrainingStepComponent>;
    let MockFormStepper;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(AssessmentReportConfirmTrainingStepComponent);
    ...
    describe('If user', () => {
        it('has nothing filled and tries to proceed, should display error messages', () => {
            ...
            expect(validity$Spy).toHaveBeenCalledWith({
                valid: false,
                messages: ['You must complete this step to continue'],
                touched: undefined
            });
